...
namespace BingTranslationClient.Bing.Translator {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private BingTranslationClient.Bing.Translator.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public BingTranslationClient.Bing.Translator.TranslationMatch[] Translations {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://api.microsofttranslator.com/V2", ConfigurationName="Bing.Translator.LanguageService")]
    public interface LanguageService {
        ...
        BingTranslationClient.Bing.Translator.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, BingTranslationClient.Bing.Translator.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, BingTranslationClient.Bing.Translator.Translation[] translations, string from, string to, BingTranslationClient.Bing.Translator.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        BingTranslationClient.Bing.Translator.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, BingTranslationClient.Bing.Translator.TranslateOptions options);
        ...
        BingTranslationClient.Bing.Translator.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, BingTranslationClient.Bing.Translator.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : BingTranslationClient.Bing.Translator.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<BingTranslationClient.Bing.Translator.LanguageService>, BingTranslationClient.Bing.Translator.LanguageService {
        ...
        public BingTranslationClient.Bing.Translator.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, BingTranslationClient.Bing.Translator.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, BingTranslationClient.Bing.Translator.Translation[] translations, string from, string to, BingTranslationClient.Bing.Translator.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public BingTranslationClient.Bing.Translator.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, BingTranslationClient.Bing.Translator.TranslateOptions options) {
        ...
        public BingTranslationClient.Bing.Translator.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, BingTranslationClient.Bing.Translator.TranslateOptions options) {
